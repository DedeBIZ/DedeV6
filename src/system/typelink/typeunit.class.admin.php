...
class TypeUnit
{
    ...
    function ListAllType($channel = 0, $nowdir = 0)
    {
        ...
        while ($row = $this->dsql->GetObject(0)) {
            ...
            if ($ispart == 0) {
                echo "<tr>";
                echo "<td style='background:#FBFCE2;' width='2%' class='bline'><img id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/dedeexplode.gif' style='margin:0 10px;cursor:pointer'></td>";
