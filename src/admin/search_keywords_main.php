...
function GetKeywordList($dsql, $pageno, $pagesize, $orderby = 'aid')
{
    ...
    <tr align='center' bgcolor='#f8fcf2'>
      <td width='5%'>".Lang('select')."</td>
      <td width='6%'><a href='javascript:;' onclick=\"ReloadPage('aid')\">id</a></td>
      <td width='20%'>".Lang('keywords')."</td>
      <td width='30%'>".Lang('result')."</td>
      <td width='6%'><a href='javascript:;' onclick=\"ReloadPage('count')\">".Lang("frequency")."</a></td>
      <td width='6%'><a href='javascript:;' onclick=\"ReloadPage('result')\">".Lang("result")."</a></td>
      <td width='15%'><a href='javascript:;' onclick=\"ReloadPage('lasttime')\">".Lang("search_keywords_last_searchtime")."</a></td>
    ...
    while ($row = $dsql->GetArray()) {
      ...
      <td>
        <a href='javascript:;' onclick='UpdateNote({$row['aid']})' class='btn btn-success btn-sm'>".Lang('update')."</a>
        <a href='javascript:;' onclick='DelNote({$row['aid']})' class='btn btn-success btn-sm'>".Lang('delete')."</a>
      </td>
    </tr>
    ";
        echo $line;
    ...
    echo "<tr align='left'>
            <td colspan='8'>
            <a href='javascript:selAll()' class='btn btn-success btn-sm'>".Lang("reverse_selection")."</a>
            <a href='javascript:noselAll()' class='btn btn-success btn-sm'>".Lang('cancel')."</a>
            <a href='javascript:delall()' class='btn btn-success btn-sm'>".Lang('delete')."</a>
           </td>
           </tr>\r\n";
    echo "</table></form>\r\n";
}
