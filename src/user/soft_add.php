...
------------------------------*/
    ...
    //返回成功信息
    $msg = "请选择您的后续操作：<a href='soft_add.php?cid=$typeid' class='btn btn-secondary btn-sm'>继续发布软件</a><a href='$artUrl' target='_blank' class='btn btn-secondary btn-sm'>查看软件</a><a href='soft_edit.php?channelid=$channelid&aid=$arcID' class='btn btn-secondary btn-sm'>修改软件</a><a href='content_list.php?channelid={$channelid}' class='btn btn-secondary btn-sm'>已发布软件管理</a>";
    $wintitle = "成功发布文章";
